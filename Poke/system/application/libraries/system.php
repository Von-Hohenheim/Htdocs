...
function error($string) {
	...
	echo '<div class="ui-widget">
			<div class="ui-state-error ui-corner-all" style="font-size: 13px; padding-left: 5px; font-family: verdana;"> 
				...
				<div class="alert alert-danger" role="alert"><span class="glyphicon glyphicon-exclamation-sign"></span> '.$string.'</div></p>
			</div>
		</div>';
		}
}
...
function alert($string) {
	...
	echo '<div class="ui-widget">
			<div class="ui-state-highlight ui-corner-all" style="font-size: 13px; padding-left: 5px; font-family: verdana;"> 
				...
				<div class="alert alert-warning" role="alert"><span class="glyphicon glyphicon-exclamation-sign"></span> '.$string.'</div></p>
			</div>
		</div>';
	}
}
