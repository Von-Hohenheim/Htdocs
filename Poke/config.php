...
$config['database']['database'] = "pokemon";

/*Name of server*/
$config['server_name'] = "PokeMasterX";
...
$config['promotions'] = array(1=>"Pokemon Trainer", 2=>"Bulbasaur", 3=>"Bulbasaur");
...
$config['groups'] = array(0=>"Player", 1=>"Player", 2=>"Tutor", 3=>"Senior Tutor", 6=>"Game Master", 5=>"Community Manager", 6=>"Administrator");
...
$config['newchar_vocations'][0][1] = "Pokemon Trainer";
...
$config['layout'] = "PokeMasterX";

/*Title of a website*/
$config['title'] = "PokeMasterX";
...
$config['housesLimit'] = 510;

/*Level to buy house*/
$config['houseLevel'] = 20;
...
$config['pagseguro']['email'] = 'roselyyribeiro@hotmail.com';
 
// Nome do Produto
$config['pagseguro']['produtoNome'] = 'Doar - PokeMasterX';
...
$config['pagseguro']['token'] = '5EA817B0700349F9AA86F7C2C306D58B';
?>
